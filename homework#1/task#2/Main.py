...
cranes = int(input('Введите количество журавлей:'))

print(f'Всего журавлей {cranes} cделал Петя {int(cranes/6)} cделал Сережа {int(cranes/6)} cделала Катя {int(cranes*2/3)}')